...
const categoryMap: DesignCategory[] = [
  ...
  { id: 7, design_name: "Дизайны карт", design_name_uz: "Karta dizaynlari", folderName: "7_card_designs" },
  ...
  { id: 12, design_name: "Мультфильмы", design_name_uz: "Multfilmlar", folderName: "12_cartoons" },
  { id: 13, design_name: "Узоры", design_name_uz: "Naqshlar", folderName: "13_pattern" },
  { id: 14, design_name: "Игры", design_name_uz: "O'yinlar", folderName: "14_games" },
  { id: 15, design_name: "Кино и музыка", design_name_uz: "Kino va musiqa", folderName: "15_movie_music" },
  { id: 16, design_name: "Аниме", design_name_uz: "Anime", folderName: "16_anime" },
];
